...
function renderCountries(countries, filters){
    ...
    document.querySelector('#country-div').innerHTML = '';

    filteredCountry.forEach(function(country){
        const createEl = document.createElement('p');
        createEl.textContent = country.name;
        document.querySelector('#country-div').appendChild(createEl);
    })
}
